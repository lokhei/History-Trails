...
public class JSONServer
{
    ...
    public String Gallery3() {
        JSONObject doc = requestJSON("https://opendata.bristol.gov.uk/api/records/1.0/search/?dataset=open-data-gallery-3-european-old-masters&q=&facet=medium&facet=object_type","","");
        String response = "";
